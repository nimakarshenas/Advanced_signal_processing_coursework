...
figure
hold on
[yhat, e, wopts] = lms_signe(xnext, x, mu, order);
...
ylabel("Estimate", "FontSize", 12, "FontWeight", "bold")
title("Evolution of adaptive weights, sign-error; \mu=" + string(mu), "FontSize", 13)
grid on
hold off
...
figure
hold on
[yhat, e, wopts] = lms_signx(xnext, x, mu, order);
...
ylabel("Estimate", "FontSize", 12, "FontWeight", "bold")
title("Evolution of adaptive weights, sign-regressor; \mu=" + string(mu), "FontSize", 13)
grid on
hold off
...
figure
hold on
[yhat, e, wopts] = lms_signex(xnext, x, mu, order);
...
ylabel("Estimate", "FontSize", 12, "FontWeight", "bold")
title("Evolution of adaptive weights, sign-sign; \mu=" + string(mu), "FontSize", 13)
grid on
hold off
